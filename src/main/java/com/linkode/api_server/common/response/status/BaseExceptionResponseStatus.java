...
public enum BaseExceptionResponseStatus implements ResponseStatus{
     ...
     * 스터디룸 관련 code : 5000 대
     */
    INVALID_ROLE(5000,HttpStatus.BAD_REQUEST.value(), "해당 스터디룸에 접근할 권한이 없습니다."),
    NOT_FOUND_STUDYROOM(5001,HttpStatus.BAD_REQUEST.value(), "스터디룸을 찾을 수 없습니다."),
    ALREADY_CREATE_CODE(5002, HttpStatus.OK.value(), "이미 생성된 초대코드가 있습니다."),
    FAILED_DELETE_STUDYROOM(5003,HttpStatus.BAD_REQUEST.value(),"스터디룸과 관련 데이터 샂게중 오류가 발생하였습니다."),
