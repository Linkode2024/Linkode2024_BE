...
public enum BaseExceptionResponseStatus implements ResponseStatus{
    ...
    FAILED_DELETE_STUDYROOM(5007,HttpStatus.BAD_REQUEST.value(),"스터디룸과 관련 데이터 삭제중 오류가 발생하였습니다."),
    OVER_MEMBER_STUDYROOM(5007,HttpStatus.BAD_REQUEST.value(),"스터디룸맴버 초과입니다."),
